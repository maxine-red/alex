...
class Memory {
   ...
   * @author Maxine Michalski
   * @param {Array} state - State of environment of this remembrance.
   * @param {Array} action - Action taken in this remembrance
   * @function
   */
 ...
 * This method tests a state and throws errors if it isn't a valit state
 * @param {Array} state - State that has to be validated.
 * @function
 * @private
 * @returns {undefined}
 */
...
/**
 * Validation method for actions
 * This method tests a action and throws errors if it isn't a valit action
 * @param {Array} action - State that has to be validated.
 * @function
 * @private
 * @returns {undefined}
 */
