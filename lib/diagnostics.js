...
class Diagnostics {
  ...
  constructor() {
    ...
    this.total_memory = Math.round(os.totalmem() / Math.pow(2,30) * 10) / 10.0;
  ...
  memory_use() {
    ...
    memory_use.rss = Math.round(memory_use.rss / Math.pow(2,20) * 100) / 100.0;
    memory_use.heapTotal = Math.round(memory_use.heapTotal / Math.pow(2,20) * 100) / 100.0;
    memory_use.heapUsed = Math.round(memory_use.heapUsed / Math.pow(2,20) * 100) / 100.0;
    memory_use.external = Math.round(memory_use.external / Math.pow(2,20) * 100) / 100.0;
    return memory_use;
  }
}
